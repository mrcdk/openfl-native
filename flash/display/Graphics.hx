...
class Graphics {
	...
	public function drawTiles (sheet:Tilesheet, data:Array<Float>, smooth:Bool = false, program:Int = 0, flags:Int = 0, count:Int = -1):Void {
		...
		lime_gfx_draw_tiles (__handle, sheet.__handle, data, program, flags, count);
	...
	private static var lime_gfx_draw_tiles = Lib.load ("lime", "lime_gfx_draw_tiles", -1);
